...
namespace CodingOpenApi\Kernel\Log;
...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('CodingOpenApi', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/coding_open_api/coding_open_api.log', $this->level(['level' => 'debug'])
        )]));
    }
